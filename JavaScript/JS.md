...
Method that is used to "split" strings into an array of substrings or directly copy strings. Interesting behavior syntacticaly to be aware of
```JS
console.log(str.split('')); // returns [ 'h', 'e', 'l', 'l', 'o', ' ', 't', 'h', 'e', 'r', 'e' ]
console.log(str.split(' ')); // returns [ 'hello', 'there' ]
console.log(str.split()); // returns [ 'hello there' ]
```
...
- Reducer as a factoral of an array, ES6 example
```JS
> let x = [1,2,3,4,5];
...
## `this`
When in "global scope" refers to the "global object" which is what `Date()` and `null` are tied to created every time a page loads (in web environment).
When in a class, it functions like other object oriented programing languages `this` keyword (i.e. refers to the instance of the objecct the class creates)
- Brief visual example to get a feel of the syntax
```JS
const global = this; // just to have a mental idea that it's the global "this"
...
let myNestedArray = [ // "first" layer, first index when indexing
  ...
  [
    [
      ...
      ['mutate', 1327.98, 'splice', 'sli# Fundamentals of JS, up to ES6
